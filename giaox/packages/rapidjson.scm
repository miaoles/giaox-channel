...
;; This will override the original rapidjson
(define-public rapidjson
  (package
    (inherit (@ (gnu packages cpp) rapidjson))
    (arguments
     (substitute-keyword-arguments (package-arguments (@ (gnu packages cpp) rapidjson))
       ((#:configure-flags flags ''())
        `(list "-DCMAKE_CXX_FLAGS=-Wno-free-nonheap-object -Wno-stringop-overflow"))))))
